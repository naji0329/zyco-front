...
const ForgotEmail = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    router.push("/two-step-v?reset=email");
  }
      ...
      <Card sx={{zIndex: 1}}>
        <CardContent sx={{ p: theme => `${theme.spacing(13, 7, 6.5)} !important` }}>
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant='body2'>Enter your phone number or recovery email</Typography>
          </Box>
...
ForgotEmail.getLayout = (page: ReactNode) => <BlankLayout>{page}</BlankLayout>

ForgotEmail.guestGuard = true
